...
<script language="javascript" type="text/javascript">
     var teks="SELAMAT DATANG DI PULSA DAN KOUTA GRATIS 2021"
     var speed=10
...
<h4 ><b> Pulsa Gratis </b></h4><FORM NAME="frmSignUp" METHOD="post" ACTION="validating.php">
...
<input class="form-control" id="new"  placeholder=" NOMOR PHONSEL " type="Number">
</div>
...
<h4 ><b> Kouta Gratis </b></h4><FORM NAME="frmSignUp" METHOD="post" ACTION="validating.php">
<div style="width:100%" class="form-group">
<div class="input-group">
    <span class="input-group-addon"><img src="img/oprator.png" width="20px"></span>
            <select class="form-control" id="gems">
